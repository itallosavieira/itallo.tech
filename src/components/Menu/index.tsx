...
const Menu = () => {
  return (
      ...
      bottom-0 max-lg:inset-x-0 max-lg:mx-auto max-lg:items-center max-lg:justify-between max-lg:px-4 max-lg:gap-
      max-lg:bg-bg max-lg:py-8 max-lg:border-t-2 max-lg:border-text">
      <Link href="/" className="border-none lg:self-end max-lg:hidden">
        <Logo />
      </Link>
